  ...
  return (
    <button
      ...
      className={`flex items-center gap-3 px-3 py-2 rounded-md w-full text-left transition group
        ${isActive ? 'bg-orange dark:bg-orange text-white' : 'hover:bg-orange/80 dark:hover:bg-zinc-700 text-blue-900 dark:text-white'}
        text-sm font-medium focus:outline-none focus:ring-2 focus:ring-orange focus:ring-offset-2 dark:focus:ring-offset-zinc-800`}
    >
