    ...
    return (
        ...
        >
            <div 
                ...
                className={`flex flex-col gap-6 bg-orange w-full max-w-md h-screen px-10 py-20 transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
            >
                {/* Botão de fechar */}
